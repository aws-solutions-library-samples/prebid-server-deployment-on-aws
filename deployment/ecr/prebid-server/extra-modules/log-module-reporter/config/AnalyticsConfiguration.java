...
public class AnalyticsConfiguration {
    ...
    LogAnalyticsReporter logAnalyticsReporter(JacksonMapper mapper) {
        logger.debug("Initializing LogAnalyticsReporter");
        return new LogAnalyticsReporter(mapper);
    }

    @Configuration
    @ConditionalOnProperty(prefix = "analytics.psdoa", name = "enabled", havingValue = "true")
    public static class PsdoaAnalyticsConfiguration {

        @Bean
        PsdoaAnalyticsReporter psdoaAnalyticsReporter(JacksonMapper jacksonMapper) {
            logger.debug("Initializing PsdoaAnalyticsReporter");
            return new PsdoaAnalyticsReporter(jacksonMapper);
        }
    }
